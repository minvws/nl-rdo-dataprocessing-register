{{--
    Copy of vendor/filament/filament/resources/views/components/sidebar/item.blade.php (Filament v3.3.54),
    with one addition: aria-current="page" on the link of the active item, so that assistive software can
    determine which navigation item represents the current page (WCAG 1.3.1). Re-sync on Filament upgrades.
--}}
@props([
    'active' => false,
