    ...
    <div class="fi-simple-layout flex min-h-screen flex-col items-center">
        ...
        >
            <main
                ...
                tabindex="-1"
                @class([
                    'fi-simple-main my-16 w-full bg-white px-6 py-12 shadow-sm outline-none ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10 sm:rounded-xl sm:px-12',
