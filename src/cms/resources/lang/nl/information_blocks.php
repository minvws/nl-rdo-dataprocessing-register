...
return [
    'avg_responsible_processing_record' => [
        ...
        'step_processing_name_extra_info' => '
            <h4 class="text-base font-semibold leading-6 text-gray-950 dark:text-gray-300 mb-1">Leg verwerkingen vast</h4>
            ...
            <h4 class="text-base font-semibold leading-6 text-gray-950 dark:text-gray-300 mb-1">Algemene informatie over de verwerking</h4>
            ...
            <h4 class="text-base font-semibold leading-6 text-gray-950 dark:text-gray-300 mb-1">Verwerkingen die niet hoeven te worden vastgelegd</h4>
        ...
        'step_responsible_extra_info' => '
            <h4 class="text-base font-semibold leading-6 text-gray-950 dark:text-gray-300 mb-1">Kies de verwerkingsverantwoordelijke</h4>
            ...
            <h4 class="text-base font-semibold leading-6 text-gray-950 dark:text-gray-300 mb-1">Algemene informatie over de verwerkingsverantwoordelijke</h4>
            ...
            <h4 class="text-base font-semibold leading-6 text-gray-950 dark:text-gray-300 mb-1">Onderlinge verdeling verantwoordelijkheid</h4>
        ...
        'step_receiver_extra_info' => '
            <h4 class="text-base font-semibold leading-6 text-gray-950 dark:text-gray-300 mb-1">Vul informatie over de ontvangers in</h4>
            ...
            <h4 class="text-base font-semibold leading-6 text-gray-950 dark:text-gray-300 mb-1">Algemene informatie over de ontvangers</h4>
            ...
            <h4 class="text-base font-semibold leading-6 text-gray-950 dark:text-gray-300 mb-1">Voorbeelden van ontvangers</h4>
        ...
        'step_processing_goal_extra_info' => '
            <h4 class="text-base font-semibold leading-6 text-gray-950 dark:text-gray-300 mb-1">Vul informatie over het doel in</h4>
            <p class="text-sm text-gray-950 dark:text-gray-300 mb-4">Geef aan voor welke doeleinden u persoonsgegevens verwerkt.</p>
            <h4 class="text-base font-semibold leading-6 text-gray-950 dark:text-gray-300 mb-1">Algemene informatie over het doel</h4>
            ...
            <h4 class="text-base font-semibold leading-6 text-gray-950 dark:text-gray-300 mb-1">Algemene informatie over de rechtsgrond</h4>
            ...
            <h4 class="text-base font-semibold leading-6 text-gray-950 dark:text-gray-300 mb-1">Uitzondering op de rechtsgrond &lsquo;gerechtvaardigd belang&rsquo; voor de overheid</h4>
        ...
        'step_stakeholder_data_extra_info' => '
            <h4 class="text-base font-semibold leading-6 text-gray-950 dark:text-gray-300 mb-1">Vul informatie over de betrokkenen en de gegevens in</h4>
            ...
            <h4 class="text-base font-semibold leading-6 text-gray-950 dark:text-gray-300 mb-1">Algemene informatie over persoonsgegevens</h4>
            ...
            <h4 class="text-base font-semibold leading-6 text-gray-950 dark:text-gray-300 mb-1">Informatie over het &quot;Verzameldoel&quot;</h4>
            ...
            <h4 class="text-base font-semibold leading-6 text-gray-950 dark:text-gray-300 mb-1">Informatie over de &quot;Bewaartermijn&quot;</h4>
            ...
            <h4 class="text-base font-semibold leading-6 text-gray-950 dark:text-gray-300 mb-1">Informatie over de &quot;Bron&quot;</h4>
            ...
            <h4 class="text-base font-semibold leading-6 text-gray-950 dark:text-gray-300 mb-1">Informatie over de &quot;Verplichte levering&quot;</h4>
            ...
            <h4 class="text-base font-semibold leading-6 text-gray-950 dark:text-gray-300 mb-1">Algemene informatie over bijzondere persoonsgegevens, strafrechtelijke gegevens en BSN</h4>
        ...
        'step_decision_making_extra_info' => '
            <h4 class="text-base font-semibold leading-6 text-gray-950 dark:text-gray-300 mb-1">Geautomatiseerde besluitvorming</h4>
            ...
            <h4 class="text-base font-semibold leading-6 text-gray-950 dark:text-gray-300 mb-1">Verbod</h4>
        ...
        'step_system_extra_info' => '
            <h4 class="text-base font-semibold leading-6 text-gray-950 dark:text-gray-300 mb-1">Vul namen van informatiesystemen/applicaties in</h4>
        ...
        'step_security_extra_info' => '
            <h4 class="text-base font-semibold leading-6 text-gray-950 dark:text-gray-300 mb-1">Toelichting maatregelen</h4>
            ...
            <h4 class="text-base font-semibold leading-6 text-gray-950 dark:text-gray-300 mb-1">Pseudonimiseren</h4>
        ...
        'step_passthrough_extra_info' => '
            <h4 class="text-base font-semibold leading-6 text-gray-950 dark:text-gray-300 mb-1">Vul informatie over de doorgifte in</h4>
            ...
            <h4 class="text-base font-semibold leading-6 text-gray-950 dark:text-gray-300 mb-1">De passende waarborgen</h4>
        ...
        'step_geb_dpia_extra_info' => '
            <h4 class="text-base font-semibold leading-6 text-gray-950 dark:text-gray-300 mb-1">Hoog Risico? Dan een GEB (DPIA)!</h4>
    ...
    'avg_processor_processing_record' => [
        ...
        'step_processor_extra_info' => '
            <h4 class="text-base font-semibold leading-6 text-gray-950 dark:text-gray-300 mb-1">Vul informatie over de subverwerker in</h4>
            ...
            <h4 class="text-base font-semibold leading-6 text-gray-950 dark:text-gray-300 mb-1">Algemene informatie over subverwerker</h4>
            ...
            <h4 class="text-base font-semibold leading-6 text-gray-950 dark:text-gray-300 mb-1">Subverwerkersovereenkomst</h4>
    ...
    'wpg_processing_record' => [
        ...
        'step_processor_extra_info' => '
            <h4 class="text-base font-semibold leading-6 text-gray-950 dark:text-gray-300 mb-1">Algemene informatie over de verwerker</h4>
            ...
            <h4 class="text-base font-semibold leading-6 text-gray-950 dark:text-gray-300 mb-1">Verwerkingsovereenkomst</h4>
        ...
        'step_receiver_extra_info' => '
            ...
            <h4 class="text-base font-semibold leading-6 text-gray-950 dark:text-gray-300 mb-1">Overdracht van politiegegevens</h4>
        ...
        'step_decision_making_extra_info' => '
            ...
            <h4 class="text-base font-semibold leading-6 text-gray-950 dark:text-gray-300 mb-1">Wanneer is geautomatiseerde besluitvorming toegestaan?</h4>
        ...
        'step_system_application_extra_info' => '
            ...
            <h4 class="text-base font-semibold leading-6 text-gray-950 dark:text-gray-300 mb-1">Vul namen van systemen/applicaties in</h4>
        ...
        'step_security_extra_info' => '
            <h4 class="text-base font-semibold leading-6 text-gray-950 dark:text-gray-300 mb-1">Vul informatie over de beveiligingsmaatregelen in</h4>
            ...
            <h4 class="text-base font-semibold leading-6 text-gray-950 dark:text-gray-300 mb-1">Pseudonimisering</h4>
    ...
    'data_breach_record' => [
        ...
        'step_responsible_extra_info' => '
            <h4 class="text-base font-semibold leading-6 text-gray-950 dark:text-gray-300 mb-1">Kies de contactpersoon van de verwerkingsverantwoordelijke uit de lijst</h4>
            ...
            <h4 class="text-base font-semibold leading-6 text-gray-950 dark:text-gray-300 mb-1">Verwerkersovereenkomst</h4>
