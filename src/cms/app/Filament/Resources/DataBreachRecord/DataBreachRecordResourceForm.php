...
class DataBreachRecordResourceForm
{
            ...
            ->schema([
                ProcessingRecordWizard::make()
                    ->schema([
                        ...
                        self::getStepDates(),
                        self::getStepIncident(),
                        self::getStepProcessingRecords(),
    ...
    private static function getStepName(): Step
    {
        ...
        return Step::make(__('data_breach_record.step_name'))
            ->schema([
                EntityNumber::make()
    ...
    {
        return Step::make(__('data_breach_record.step_responsible'))
            ->schema([
    ...
    private static function getStepDates(): Step
    {
        return Step::make(__('data_breach_record.step_dates'))
            ->schema([
    ...
    private static function getStepIncident(): Step
    {
        ...
        return Step::make(__('data_breach_record.step_incident'))
            ->schema([
    ...
    public static function getStepProcessingRecords(): Step
    {
        return Step::make(__('data_breach_record.step_processing_records'))
            ->schema([
    ...
    {
        return Step::make(__('data_breach_record.step_attachments'))->schema([
            SelectMultipleWithLookup::makeForRelationshipWithCreate(
                'document_id',
                'documents',
