        ...
        return $form
            ->schema([
                ProcessingRecordWizard::make()
                    ->schema([
                        ProcessingRecordStep::make(__('avg_processor_processing_record.step_processing_name'))
                            ->schema(AvgProcessorProcessingRecordResourceFormSchemas::getProcessingName()),
                        ProcessingRecordStep::make(__('avg_processor_processing_record.step_responsible'))
                            ->schema(AvgProcessorProcessingRecordResourceFormSchemas::getResponsible()),
                        ProcessingRecordStep::make(__('avg_processor_processing_record.step_processor'))
                            ->schema(AvgProcessorProcessingRecordResourceFormSchemas::getProcessors()),
                        ProcessingRecordStep::make(__('avg_processor_processing_record.step_receiver'))
                            ->schema(AvgProcessorProcessingRecordResourceFormSchemas::getReceiver()),
                        ProcessingRecordStep::make(__('avg_processor_processing_record.step_processing_goal'))
                            ->schema(AvgProcessorProcessingRecordResourceFormSchemas::getProcessingGoal()),
                        ProcessingRecordStep::make(__('avg_processor_processing_record.step_involved_data'))
                            ->schema(AvgProcessorProcessingRecordResourceFormSchemas::getInvolvedData()),
                        ProcessingRecordStep::make(__('avg_processor_processing_record.step_decision_making'))
                            ->schema(AvgProcessorProcessingRecordResourceFormSchemas::getDecisionMaking()),
                        ProcessingRecordStep::make(__('avg_processor_processing_record.step_system'))
                            ->schema(AvgProcessorProcessingRecordResourceFormSchemas::getSystem()),
                        ProcessingRecordStep::make(__('avg_processor_processing_record.step_security'))
                            ->schema(AvgProcessorProcessingRecordResourceFormSchemas::getSecurity()),
                        ProcessingRecordStep::make(__('avg_processor_processing_record.step_passthrough'))
                            ->schema(AvgProcessorProcessingRecordResourceFormSchemas::getPassthrough()),
                        ProcessingRecordStep::make(__('avg_processor_processing_record.step_geb_pia'))
                            ->schema(AvgProcessorProcessingRecordResourceFormSchemas::getGebPia()),
                        ProcessingRecordStep::make(__('avg_processor_processing_record.step_contact_person'))
                            ->schema(AvgProcessorProcessingRecordResourceFormSchemas::getContactPerson()),
                        ProcessingRecordStep::make(__('avg_processor_processing_record.step_attachments'))
                            ->schema(AvgProcessorProcessingRecordResourceFormSchemas::getAttachments()),
                        ProcessingRecordStep::make(__('avg_processor_processing_record.step_remarks'))
