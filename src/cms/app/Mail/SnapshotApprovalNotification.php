...
class SnapshotApprovalNotification extends Mailable
{
    use Queueable;
    ...
    {
        return __('snapshot_approval.mail_notification_subject');
    }

    public function content(): Content
    {
        return new Content(markdown: 'mail.snapshot_approval.notification');
    }
}
